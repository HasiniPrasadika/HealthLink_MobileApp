...
class SeniorCarePage extends StatefulWidget {
  const SeniorCarePage({super.key});

  @override
  State<SeniorCarePage> createState() => _SeniorCarePageState();
}

class _SeniorCarePageState extends State<SeniorCarePage> {
